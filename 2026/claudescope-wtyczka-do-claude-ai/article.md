...
![Panel boczny ClaudeScope przyklejony do okna claude.ai|w=300](./assets/extension-mini-panel.png)
...
![Rozkład promptów między modelami Claude|w=240](./assets/extension-prompts-per-model.png)
...
![Szczegółowy widok limitów sesji|w=240](./assets/extension-session-limits.png)
...
![Informacje o cyklu subskrypcji|w=240](./assets/extension-subscription-details.png)
...
![Mapa godzin szczytu w skali doby|w=240](./assets/extension-peak-hours.png)
...
![Wykres aktywności i zużycia|w=240](./assets/extension-usage.png)
...
![Komunikat błędu na panelu bocznym|w=300](./assets/extension-error-message.png)
...
![Okno Firefoxa z pytaniem o instalację rozszerzenia ClaudeScope|w=260](./assets/firefox-installation.png)
