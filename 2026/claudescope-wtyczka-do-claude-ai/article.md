...
![Panel boczny ClaudeScope przyklejony do okna claude.ai|w=640](./assets/extension-mini-panel.png)
...
![Rozkład promptów między modelami Claude|w=480](./assets/extension-prompts-per-model.png)
...
![Szczegółowy widok limitów sesji|w=480](./assets/extension-session-limits.png)
...
![Informacje o cyklu subskrypcji|w=480](./assets/extension-subscription-details.png)
...
![Mapa godzin szczytu w skali doby|w=480](./assets/extension-peak-hours.png)
...
![Wykres aktywności i zużycia|w=480](./assets/extension-usage.png)
...
![Komunikat błędu na panelu bocznym|w=560](./assets/extension-error-message.png)
...
![Okno Firefoxa z pytaniem o instalację rozszerzenia ClaudeScope|w=540](./assets/firefox-installation.png)
