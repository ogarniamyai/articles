...
![Panel boczny ClaudeScope przyklejony do okna claude.ai|w=380](./assets/extension-mini-panel.png)
...
![Komunikat błędu na panelu bocznym|w=340](./assets/extension-error-message.png)
...
![Okno Firefoxa z pytaniem o instalację rozszerzenia ClaudeScope|w=320](./assets/firefox-installation.png)
